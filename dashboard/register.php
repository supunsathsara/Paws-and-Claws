...
<html lang="en">
  <head>
    ...
    <title>Register | Paws & Claws</title>
    <!-- Fonts and icons -->
    ...
    <!-- Main Styling -->
    <link href="./assets/css/auth.min.css" rel="stylesheet" />
  </head>
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO auth (email, name, password) VALUES (?, ?, ?)";

    // Prepare the statement
    $statement = mysqli_prepare($con, $query);

    // Bind the parameters
    mysqli_stmt_bind_param($statement, "sss", $email, $name, $hashedPassword);
  ...
  <body class="m-0 font-sans antialiased font-normal bg-white text-start text-base leading-default text-slate-500">
    ...
    <nav class="absolute top-0 left-0 right-0 z-30 flex flex-wrap items-center px-4 py-2 mx-6 my-4 shadow-soft-2xl rounded-blur bg-white/80 backdrop-blur-2xl backdrop-saturate-200 lg:flex-nowrap lg:justify-start">
        <div class="flex items-center justify-between w-full p-0 pl-6 mx-auto flex-wrap-inherit">
          <a class="py-2.375 text-sm mr-4 ml-4 whitespace-nowrap font-bold text-slate-700 lg:ml-0" href="/"> Paws & Claws</a>
          ...
          <div navbar-menu class="items-center flex-grow overflow-hidden transition-all duration-500 ease-soft lg-max:max-h-0 basis-full lg:flex lg:basis-auto">
            <ul class="flex flex-col pl-0 mx-auto mb-0 list-none lg:flex-row xl:ml-auto">
              ...
              <li>
                <a class="block px-4 py-2 mr-2 font-normal transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-sm text-slate-700 lg:px-2" href="/services.html">
                  <i class="mr-1 fa fa-user opacity-60"></i>
                  Services
                </a>
              </li>
              <li>
                <a class="block px-4 py-2 mr-2 font-normal transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-sm text-slate-700 lg:px-2" href="/contact.html">
            ...
            <ul class="hidden pl-0 mb-0 list-none lg:block lg:flex-row">
              <li>
                <a href="./login.php" class="leading-pro hover:scale-102 hover:shadow-soft-xs active:opacity-85 ease-soft-in text-xs tracking-tight-soft shadow-soft-md bg-150 bg-x-25 bg-gradient-to-tl from-gray-900 to-slate-800 rounded-3.5xl mb-0 mr-1 inline-block cursor-pointer border-0 bg-transparent px-8 py-2 text-center align-middle font-bold uppercase text-white transition-all">Login</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="container z-10">
            <div class="flex flex-wrap justify-center -mx-3">
              <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
                ...
                <p class="text-white">create new account and get started for free.</p>
              ...
              <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex-auto p-6">
                  <form role="form text-left" action="#" method="post">
                    <div class="mb-4">
                      <input type="text" required name="name" class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Name" aria-label="Name" aria-describedby="email-addon" />
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      <input type="password" required name="password" class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Password" aria-label="Password" aria-describedby="password-addon" />
                    </div>
                    ...
                    <p class="mt-4 mb-0 leading-normal text-sm">Already have an account? <a href="./login.php" class="font-bold text-slate-700">Sign in</a></p>
                  </form>
                </div>
              </div>
            </div>
